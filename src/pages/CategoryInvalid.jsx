...
const CategoryInvalid = () => {
  ...
  return (
    <div className='flex flex-col items-center '>
      <Header isPure={false}/>
      <SecondaryPageseSubheader title={'Для людей с ограниченными возможностями.'} links={['АВТО ШКОЛА', 'ПРЕДЛОЖЕНИЯ', 'КУРСЫ ВОЖДЕНИЯ']} linksArdess={['/', '/offers', '/driving-courses']} lastAdres={'Для людей с ограниченными возможностями.'}/>
      ...
      <div className='max-w-[1270px] flex flex-row justify-start w-full text-[1.1em] lg:text-[1.35em] px-[10px]'>{t('Водительское удостоверение категории В дает право управлять транспортным средством массой не более 3,5 тонн.')}<br/>{t('В предложение школы «Авто-Школа» входит также курс категории В. Для людей с ограниченными возможностями здание, в котором проводятся лекции ( ул. Водительская 15, кабинет 411, 4 этаж), приспособлено для людей с ограниченными возможностями, сзади расположен пандус для инвалидных колясок. здания и доступ на 4 этаж обеспечивается лифтом. Автомобиль специально создан под нужды студентов.')}</div>
      <HowGetOffer
