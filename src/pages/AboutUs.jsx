...
import AboutUsGalery1 from '../components/AboutUsGalery1'
...
const AboutUs = () => {
  ...
  return (
    <div className='flex flex-col items-center '>
      <Header isPure={false}/>
      <SecondaryPageseSubheader title={'О НАС'} links={['АВТО СТОП']} linksArdess={['/']} lastAdres={'О НАС'}/>
