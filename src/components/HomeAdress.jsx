...
const HomeAdress = () => {
  ...
  return (
    <div className='w-full flex flex-col items-center py-[30px] text-center lineHeightMedium'>
      ...
      <div className='lg:text-[2.5em] text-[1.7em] px-[10px] mt-[20px] max-w-[1170px]'>{t('Площадь для вождения расположена на территории завода легковых автомобилей по адресу ')}<span className='text-[#0378db]'>{t('ул. Водительская 123')}</span></div>
